  ...
  Widget _buildInviteCard(String uid) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(colors: [AppColors.primary.withValues(alpha: 0.15), AppColors.pink.withValues(alpha: 0.1)]),
  ...
  Widget _buildFriendTile(UserModel friend, String myUid, String? partnerId, {Key? key}) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(14),
        border: Border.all(
          color: isPartner ? AppColors.pink.withValues(alpha: 0.5) : AppColors.border,
