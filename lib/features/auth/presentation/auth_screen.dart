          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(colors: [AppColors.primary.withValues(alpha: 0.25), Colors.transparent]),
              ),
            ),
          ),
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                gradient: RadialGradient(colors: [AppColors.pink.withValues(alpha: 0.2), Colors.transparent]),
              ),
            ),
          ),
          SafeArea(
