                ...
                Row(
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 11,
                        color: widget.model.isPlaying ? AppColors.online.withValues(alpha: 0.9) : AppColors.textTertiary,
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          colors: [AppColors.surfaceHigh, AppColors.primary.withValues(alpha: 0.2)],
